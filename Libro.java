...
package ejercicioextras03colecciones;
...
*/ 
	...
	HashSet<LibroEntidades>   libro = new HashSet();
int cont =0;
boolean confirmacion = true;
do{
	    LibroEntidades libros = new LibroEntidades();
	    System.out.println("Ingrese titulo de la obra: ");
	    libros.setTitulo(leer.next());
	    System.out.println("Ingrese Autor: ");
	    libros.setAutor(leer.next());
	    cont++;
	    libros.setNumEjemp(cont);
	    libro.add(libros);

	    System.out.println("Desea agregar otra obra: ");
